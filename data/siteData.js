export const companyInfo = {
  name: 'Core King Ply',
  marketedBy: 'Shree Ashapuri Enterprise',
  ...
  fullDescription:
    'Core King Plywood is one of India\'s fastest-growing manufacturers and suppliers of premium calibrated plywood. Proudly marketed and distributed by Shree Ashapuri Enterprise, we ensure that our products reach every corner with the same promise of quality and reliability.',
  aboutElevateText:
    'Core King Plywood is one of India\'s fastest-growing manufacturers and suppliers of premium calibrated plywood. Known for strength, precision, and durability, our plywood and laminate products are crafted to meet the highest standards for both residential and commercial applications.',
  aboutMarketedText:
    'Proudly marketed and distributed by Shree Ashapuri Enterprise, we ensure that our products reach every corner with the same promise of quality and reliability.',
  aboutClosingText:
    'From blockboards to shuttering plywood, each product reflects our commitment to excellence. With modern processes and expert craftsmanship, Core King Plywood - marketed by Shree Ashapuri Enterprise - delivers dependable solutions that stand the test of time.',
  ...
  phone: '+91 9624277017',
  phoneDisplay: '+91 9624277017',
  whatsapp: '+91 9624277017',
  email: 'corekingply@gmail.com',
  supportEmail: 'info@corekingply.com',
  whatsappLink: 'https://wa.me/919624277017',
...
// Hero Sliders matching Briterply
export const heroSlides = [
  {
    id: 1,
    image: '/images/hero1.jpg',
    alt: 'Core King Ply Pro Plywood',
  },
  {
    id: 2,
    image: '/images/hero2.jpg',
    alt: 'Core King Gold Plywood',
  },
];
...
export const products = [
  {
    ...
    warranty: '20 Years',
    technology: '4-time press, calibrated',
    applications: 'Furniture, partitions, paneling',
    description:
      'Core King Gold is a reliable plywood solution for homes and commercial use, offering long-lasting durability and superior nail-holding strength at an affordable price.',
    features: [
      ...
      'Perfect for furniture, partitions, and paneling',
    ],
    image: '/images/gold_plywood.jpg',
  },
  {
    slug: 'core-king-club',
    ...
    warranty: '30 Years',
    technology: '4-time press, calibrated',
    applications: 'Kitchens, bathrooms, premium furniture',
    description:
    ...
    features: [
      'Superior water resistance for wet areas',
      'Premium grade materials and construction',
      'Enhanced termite and borer protection',
      'Perfect for kitchens, bathrooms, and premium furniture',
      'Long-term structural integrity guarantee',
    ],
    image: '/images/club-plywood.jpg',
  },
