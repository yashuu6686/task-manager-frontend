...
export const products = [
  {
    ...
    name: 'Core King BWR',
    category: 'Plywoods',
    tagline: 'High-Density Commercial & Residential BWR Plywood',
    grade: 'BWR (Boiling Water Resistant)',
    gradeShort: 'IS:303 BWR',
    standard: 'IS:303 Commercial BWR Benchmark',
    warranty: '20 Years Warranty',
    warrantyShort: '20 Years',
    technology: '4-Stage Hydraulic Hot Press, Machine Calibrated',
    resin: 'Fortified Melamine BWR Synthetic Resin',
    coreTimber: '100% Selected High-Density Hardwood Timber',
    calibration: 'Machine Calibrated (±0.1 mm precision)',
    ...
    technicalSpecs: [
      ...
      { label: 'Warranty Protection', value: '20 Years Guarantee' },
    ],
    image: '/CORE-BWR.jpeg',
  },
  {
    ...
    warranty: '30 Years Replacement',
    warrantyShort: '30 Years',
    ...
    features: [
      ...
      'Long-term structural integrity with 30-year replacement warranty',
    ],
    technicalSpecs: [
      ...
      { label: 'Warranty Protection', value: '30 Years Replacement' },
    ],
    image: '/CORE-KING-CLUB710.jpeg',
  },
